...
public final class MiniKeyboard {
     ...
     * Some of the key size defaults can be overridden per row from what the {@link MiniKeyboard}
     * defines.
     *
    ...
    public static class Row {
         ...
         * {@link MiniKeyboard#EDGE_TOP EDGE_TOP} and {@link MiniKeyboard#EDGE_BOTTOM EDGE_BOTTOM}
         */
        ...
        private MiniKeyboard parent;

        public Row(MiniKeyboard parent) {
            this.parent = parent;
        }

        public Row(Resources res, MiniKeyboard parent, XmlResourceParser parser) {
            this.parent = parent;
